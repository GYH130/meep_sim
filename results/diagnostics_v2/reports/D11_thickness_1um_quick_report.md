...
| air_core_not_collapsed_1000nm | PASS | inner_top=18, inner_bottom=18, inner_depth=14 |
| inner_air_core_inside_unit_cell_1000nm | PASS | period=50, vertices=[(-9.0, 0.0), (9.0, 0.0), (14.095583279726833, -14.0), (-3.9044167202731668, -14.0)] |
...
| --- | --- | --- | --- | --- | --- | --- | --- |
| scaled_inner_wall_film_1um | Ez | 0.239701 | 0.332507 | nan | nan | SCALED_INNER_WALL_FILM_ROUTE_FAIL_FOR_HIGH_EMISSIVITY | CODE_PASS |
| scaled_inner_wall_film_1um | Hz | 0.365143 | 0.426788 | nan | nan | PARTIAL_ABSORPTION_ENHANCEMENT_BUT_BELOW_CONTINUE_THRESHOLD | CODE_PASS |
| scaled_inner_wall_film_1um | unpolarized_2D_proxy | 0.302422 | 0.379648 | nan | nan | PARTIAL_ABSORPTION_ENHANCEMENT_BUT_BELOW_CONTINUE_THRESHOLD | CODE_PASS |
...
- Spectra: `/mnt/c/Users/admin/Meep_Simulation/meep_sim/results/diagnostics_v2/tables/D11_thickness_1um_quick_spectra.csv`
- Metrics: `/mnt/c/Users/admin/Meep_Simulation/meep_sim/results/diagnostics_v2/tables/D11_thickness_1um_quick_metrics.csv`
- Resolution check: `/mnt/c/Users/admin/Meep_Simulation/meep_sim/results/diagnostics_v2/tables/D11_thickness_1um_quick_resolution_check.csv`
- PML check: `/mnt/c/Users/admin/Meep_Simulation/meep_sim/results/diagnostics_v2/tables/D11_thickness_1um_quick_pml_check.csv`
- Log: `/mnt/c/Users/admin/Meep_Simulation/meep_sim/logs/diagnostics_v2/D11_thickness_1um_quick.log`
