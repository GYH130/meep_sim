# L — homogeneous boundary screening only

Uniform air/slab numerical width 2 um; not a machining-period study or slotted-geometry qualification.

Selected profile remains unverified for the full 50 um cell and grazing slot diffraction orders.
