...
spec = importlib.util.spec_from_file_location('export_l', ROOT / 'export_l.py')
...
class ExportTests(unittest.TestCase):
    def fixture(self, root):
        ...
        output = root / 'runs/boundary_20260924_L/flat'
    ...
    def test_complete_hash_checked_immutable_generations(self):
        with tempfile.TemporaryDirectory() as folder:
            ...
            with tarfile.open(root / 'exports' / second['raw_file']) as archive:
                ...
                self.assertIn('boundary_screen_L/cache/references/example/reference.npz', names)
                self.assertIn('boundary_screen_L/runs/boundary_20260924_L/flat/field.npz', names)
            with tarfile.open(root / 'exports' / second['compact_file']) as archive:
                ...
                self.assertIn('meep_screen_archive/boundary_screen_L/L_FILES.json', names)
