...
- Active-solver interval union: 17.4925 h / 48 h.
- MPI rank-hours: 69.9700; calendar span: 33.6257 h.
...
- slot32p: not qualified
- strict32p: not qualified
- mirror32p: not qualified
- flat32s: not qualified
- 11 additional failed/not-run checks; full list in summary.json.
...
- For status use `python -B -m ti2d.cli status --manifest /root/autodl-tmp/meep_sim/meep_screen/expiry_campaign/runs/expiry_20260922_H/manifest.json`; report regeneration is offline.
