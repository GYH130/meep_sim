...
class Queue:
    ...
    def execute(self, task, attempt, admission=None):
        ...
        # The solver must finish collective E/D extraction before the supervisor
        # sends SIGTERM, including when expiry shortens the nominal case cap.
        env.update(PYTHONDONTWRITEBYTECODE="1", TI2D_WALL_TIMEOUT_SECONDS=str(max(1., effective_timeout - 120.)),
