...
- Active-solver interval union: 8.5979 h / 48 h.
- MPI rank-hours: 34.3917; calendar span: 18.8882 h.
...
- baseline_r32_p_plus30: not qualified
...
- For status use `python -B -m ti2d.cli status --manifest /root/autodl-tmp/meep_sim/meep_screen/runs/baseline_r32_20260922_E/manifest.json`; report regeneration is offline.
